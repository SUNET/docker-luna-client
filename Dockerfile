...
RUN apt-get -y install opensc git-core python-dev build-essential libz-dev python-pip mercurial swig
RUN pip install --upgrade hg+https://bitbucket.org/gambit4id/pykcs11#egg=pykcs11
